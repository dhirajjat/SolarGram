...
import tl from "../../assets/images/talngan.png";
...
function Talngana() {
  return (
    ...
    <div className=" bg-black text-white text-sm w-full h-52 lg:h-[350px] lg:px-10 lg:py-10   bg-opacity-60 relative z-10">
      <div className=" lg:mt-20 mt-16 mx-10 lg:mx-32">
        ...
        Solar Power Solution Providers in Talngana{" "}
        </span>
        
      </div>
    </div>
  </div>
  <div className='lg:flex mx-5  lg:ml-52  lg:space-x-10 mt-12 lg:my-20'>
    <div className=''>
    <img
      src={tl}
      alt="Background"
    ...
    <div className='mt-5 '>
        <h1 className='lg:text-4xl text-3xl text-yellow-500 font-semibold mb-5 text-wrap lg:me-32'>Solar Power Solution Providers in <span className='text-yellow-600'>Talngana</span> </h1>
        <span className='text-gray-700'>Solar Power Solution Providers in Talngana .
  ...
  <div className='lg:flex mx-5 my-8'>
    <div className='lg:w-1/2  lg:ml-40'>
        ...
        <span className='text-gray-500 lg:pl-20'>Solar Power Solution Providers in Talngana </span>
