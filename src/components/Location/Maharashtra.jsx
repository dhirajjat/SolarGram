...
function Maharashtra() {
  ...
  className=" lg:h-[530px] lg:w-[1000px]  lg:rounded-full rounded-3xl  "
    ...
    <div className='mt-5'>
        <h1 className='text-3xl text-yellow-500 font-semibold mb-5'> Government Projects</h1>
  ...
  <div className='lg:flex my-8 mx-5 lg:mx-0'>
    <div className='lg:w-1/2 lg:ml-40'>
        <h1 className='lg:text-5xl text-3xl font-bold lg:text-end lg:my-4'>Uses and <span className='text-yellow-500'>Benefits</span></h1>
